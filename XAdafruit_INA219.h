// REname XAdafruit_INA2319 to prevent Arduino Name Clashes
...
/** default I2C address **/
#define INA219_ADDRESS (0x45) // 1000000 (A0+A1=GND)
 ...
 */
class XAdafruit_INA219 {
public:
  XAdafruit_INA219(uint8_t addr = INA219_ADDRESS);

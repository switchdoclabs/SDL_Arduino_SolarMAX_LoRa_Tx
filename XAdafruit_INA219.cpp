// Renamed to prevent arduino library classes
/*!
 * @file XAdafruit_INA219.cpp
 *
 ...
 *          value to write
 */
void XAdafruit_INA219::wireWriteRegister(uint8_t reg, uint16_t value) {
 ...
 *          read value
 */
void XAdafruit_INA219::wireReadRegister(uint8_t reg, uint16_t *value) {
 ...
 */
void XAdafruit_INA219::setCalibration_32V_2A() {
 ...
 *          boolean value
 */
void XAdafruit_INA219::powerSave(bool on) {
  uint16_t current;
 ...
 *  @note   These calculations assume a 0.1 ohm resistor is present
 */
void XAdafruit_INA219::setCalibration_32V_1A() {
  // By default we use a pretty huge range for the input voltage,
  // which probably isn't the most appropriate choice for system
  // that don't use a lot of power.  But all of the calculations
  // are shown below if you want to change the settings.  You will
 ...
 */
void XAdafruit_INA219::setCalibration_16V_400mA() {
 ...
 */
XAdafruit_INA219::XAdafruit_INA219(uint8_t addr) {
  ina219_i2caddr = addr;
 ...
 */
void XAdafruit_INA219::begin(TwoWire *theWire) {
  _i2c = theWire;
  init();
}
 ...
 */
int16_t XAdafruit_INA219::getBusVoltage_raw() {
  uint16_t value;
 ...
 */
int16_t XAdafruit_INA219::getShuntVoltage_raw() {
  uint16_t value;
 ...
 */
int16_t XAdafruit_INA219::getCurrent_raw() {
  uint16_t value;
 ...
 */
int16_t XAdafruit_INA219::getPower_raw() {
  uint16_t value;
 ...
 */
float XAdafruit_INA219::getShuntVoltage_mV() {
  int16_t value;
 ...
 */
float XAdafruit_INA219::getBusVoltage_V() {
 ...
 */
float XAdafruit_INA219::getCurrent_mA() {
 ...
 */
float XAdafruit_INA219::getPower_mW() {
